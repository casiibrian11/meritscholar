...
@section('content')
<input type="hidden" class="form-control" id="delete-route" value="{{route('requirements-delete')}}" readonly>


<h3 class="mt-2 p-0"><i class="fa fa-list-alt"></i> Requirements ({{ $data['requirements']->total() }})</h3>
    ...
    <div class="col-sm-12 p-0">
        <div class="card p-0 main-body">
            <div class="card-header text-right">
                <a href="/requirements/manage" class="btn btn-xs btn-success add-new p-1 px-3">
                    <i class="fa fa-plus"></i> ADD NEW
                </a>
            </div>
            <div class="card-body">
                <div class="btn-group mb-2 d-none" role="group" aria-label="Active">
                    <a href="/requirements" type="button" class="btn btn-sm @if (empty($data['visible'])) btn-success @else btn-outline-secondary @endif">All</a>
